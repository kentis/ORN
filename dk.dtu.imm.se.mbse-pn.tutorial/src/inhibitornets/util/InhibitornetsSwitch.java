 ...
 * @generated
 */
public class InhibitornetsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InhibitornetsPackage.INHIBITOR_ARC: {
				...
				if (result == null) result = casePnmlcoremodel_Arc(inhibitorArc);
				if (result == null) result = caseObject(inhibitorArc);
				if (result == null) result = caseID(inhibitorArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InhibitornetsPackage.READ_ARC: {
				ReadArc readArc = (ReadArc)theEObject;
				T result = caseReadArc(readArc);
				if (result == null) result = caseArc(readArc);
				if (result == null) result = casePnmlcoremodel_Arc(readArc);
				if (result == null) result = caseObject(readArc);
				if (result == null) result = caseID(readArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Read Arc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Read Arc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReadArc(ReadArc object) {
		return null;
	}
