 ...
 * <ul>
 *   <li>{@link nppnnets.impl.PragStructureImpl#getName <em>Name</em>}</li>
 *   <li>{@link nppnnets.impl.PragStructureImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PragStructureImpl extends EObjectImpl implements PragStructure {
	...
	protected EClass eStaticClass() {
		return NppnnetsPackage.Literals.PRAG_STRUCTURE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NppnnetsPackage.PRAG_STRUCTURE__NAME, oldName, name));
	}
	...
	public void setArguments(Object newArguments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NppnnetsPackage.PRAG_STRUCTURE__ARGUMENTS, oldArguments, arguments));
	}
