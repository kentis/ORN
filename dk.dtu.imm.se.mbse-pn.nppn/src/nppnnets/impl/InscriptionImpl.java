 ...
 * <ul>
 *   <li>{@link nppnnets.impl.InscriptionImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InscriptionImpl extends LabelImpl implements Inscription {
	/**
	...
	protected EClass eStaticClass() {
		return NppnnetsPackage.Literals.INSCRIPTION;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NppnnetsPackage.INSCRIPTION__TEXT, oldText, text));
	}
