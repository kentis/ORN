...
/**
 * This is the item provider adapter for a {@link orn.Ontology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OntologyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ontology_structure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ontology_structure_feature", "_UI_Ontology_type"),
				 OrnPackage.Literals.ONTOLOGY__STRUCTURE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = crop(((Ontology)object).getText());
