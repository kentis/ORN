...
/**
 * This is the item provider adapter for a {@link orn.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider
	extends org.pnml.tools.epnk.pntypes.hlpng.pntd.hlpngdefinition.provider.PageItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_ontology_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_ontology_feature", "_UI_Page_type"),
				 OrnPackage.Literals.PAGE__ONTOLOGY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OrnPackage.Literals.PAGE__PRAGMATICS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 OrnFactory.eINSTANCE.createPlace()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 OrnFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 OrnFactory.eINSTANCE.createPage()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 OrnFactory.eINSTANCE.createArc()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 OrnFactory.eINSTANCE.createRefPlace()));

		newChildDescriptors.add
			(createChildParameter
				(OrnPackage.Literals.PAGE__PRAGMATICS,
				 OrnFactory.eINSTANCE.createPragmatics()));
	}
