...
public class OrnItemProviderAdapterFactory extends OrnAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link orn.OntologyStructure} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected OntologyStructureItemProvider ontologyStructureItemProvider;

	/**
	 * This creates an adapter for a {@link orn.OntologyStructure}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createOntologyStructureAdapter() {
		if (ontologyStructureItemProvider == null) {
			ontologyStructureItemProvider = new OntologyStructureItemProvider(this);
		}

		return ontologyStructureItemProvider;
	}
	...
	public void dispose() {
		...
		if (ontologyStructureItemProvider != null) ontologyStructureItemProvider.dispose();
	}
