...
public class ArcTypeFigure extends ArcFigure {
	...
	public ArcTypeFigure(Arc arc) {
		super();
		// eki: Note that we remember the model element this figure is
		//      representing! This is important for updating dependent
		//      on changes in the arc's context.
		this.arc = arc;
        setType();
	}
	...
	private void setType() {
		...
		ArcType arcTypeAttribute = arc.getType();
		TYPE oldType = type;
