...
public class FunctionalCompletionProcessor implements IContentAssistProcessor {
	...
	public ICompletionProposal[] computeCompletionProposals(ITextViewer viewer,
		...
		if(prefix.equals("ORN") || offset == 0){
			ICompletionProposal compl = new CompletionProposal(FunctionalConstants.OWL_TEMPLATE, 
					0, 0, 
					0,
					null,
